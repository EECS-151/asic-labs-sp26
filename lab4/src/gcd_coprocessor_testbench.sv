...
module gcd_coprocessor_testbench;
  ...
  logic        reset;
  logic        operands_val;
  logic [15:0] operands_bits_A;
  logic [15:0] operands_bits_B;
  logic        operands_rdy;
  logic        result_val;
  ...
  logic [15:0] test_A       [num_tests-1:0];
  logic [15:0] test_B       [num_tests-1:0];
  logic [15:0] test_results [num_tests-1:0];
